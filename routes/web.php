...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('settings/change-language', [\App\Http\Controllers\HomeController::class, 'changeLanguage'])->name('settings.change_language');
    ...
    Route::group(['prefix' => 'tasks'], function () {
        ...
        Route::get('{task}/links/{link}/edit', [TaskLinkController::class, 'edit'])->name('task-links.edit');
        Route::put('{task}/links/{link}', [TaskLinkController::class, 'update'])->name('task-links.update');
