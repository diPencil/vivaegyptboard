...
class CompanyObserver
{
    ...
    private function copyFromGlobalSettings($company)
    {
        ...
        $company->login_logo = $globalSetting->login_logo;
        $company->login_ui = $globalSetting->login_ui;
    ...
    public function saving(Company $company)
    {
        ...
        if ($company->id === 1 && !isRunningInConsoleOrSeeding()) {
            ...
            // Always sync these new fields for company 1
            $global->login_logo = $company->login_logo;
            $global->login_ui = $company->login_ui;
