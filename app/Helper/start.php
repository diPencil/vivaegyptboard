...
if (!function_exists('vivaegypttravel_plugins')) {

    // @codingStandardsIgnoreLine
    function vivaegypttravel_plugins()
    {

        if (!cache()->has('vivaegypttravel_plugins')) {
            $plugins = \Nwidart\Modules\Facades\Module::allEnabled();
            cache(['vivaegypttravel_plugins' => array_keys($plugins)]);
        }

        return cache('vivaegypttravel_plugins');
    }
...
if (!function_exists('isVivaEgyptTravelSaas')) {

    function isVivaEgyptTravelSaas()
    {
        return strtolower(config('app.app_name')) === 'vivaegypttravel-saas';
    }

}

if (!function_exists('isVivaEgyptTravel')) {

    function isVivaEgyptTravel()
    {
        return strtolower(config('app.app_name')) === 'vivaegypttravel';
    }
...
if (!function_exists('getDomain')) {
    ...
    {
        if (!$host) {
            $host = $_SERVER['SERVER_NAME'] ?? 'vivaegypttravel-saas.test';
        }
