...
class HomeController extends Controller
{
    ...
    {
        $setting = \App\Models\LanguageSetting::where('language_code', $request->lang)
    ...
    public function installedModule()
    {
        ...
        $enableModules = [];
        $enableModules['application'] = 'vivaegypttravel';
        $enableModules['version'] = $applicationVersion;
        $enableModules['vivaegypttravel'] = $applicationVersion;
        ...
        } elseif (((int)str_replace('.', '', $enableModules['vivaegypttravel'])) < 400) {
