...
class Module extends BaseModel
{
        ...
        [
            ...
            'permissions' => [
                ...
                [
                    'allowed_permissions' => Permission::ALL_4_ADDED_1_OWNED_2_BOTH_3_NONE_5,
                    'is_custom' => 1,
                    'name' => 'edit_task_links',
                ],
                [
                    'allowed_permissions' => Permission::ALL_4_ADDED_1_OWNED_2_BOTH_3_NONE_5,
                    'is_custom' => 1,
                    'name' => 'delete_task_links',
                ],
                [
                    'allowed_permissions' => Permission::ALL_4_ADDED_1_OWNED_2_BOTH_3_NONE_5,
                    'is_custom' => 1,
    ...
    public static function validateVersion($module)
    {
        ...
        if ($parentMinVersion >= File::get('version.txt')) {
            ...
            $message = 'To activate <strong>' . $module . '</strong> module, minimum version of <b>vivaegypttravel application</b> must be greater than equal to <b>' . $parentMinVersion . '</b> But your application version is <b>' . File::get('version.txt') . '</b>. Please upgrade the application to latest version';
