...
class GlobalSetting extends BaseModel
{
    ...
    public function getLogoUrlAttribute()
    {
        ...
        if (is_null($this->light_logo)) {
            return asset('img/vivaegypttravel-logo.png');
        }
    ...
    public function getLoginLogoUrlAttribute()
    {
        if (is_null($this->login_logo)) {
            return $this->logo_url;
        }

        return asset_url_local_s3('app-logo/' . $this->login_logo);
    }
    ...
    public function maskedLoginLogoUrl(): Attribute
    {
        return Attribute::make(
            get: function () {
                if (is_null($this->login_logo)) {
                    return $this->masked_logo_url;
                }

                return $this->generateMaskedImageAppUrl('app-logo/' . $this->login_logo);
            },
        );
    }
