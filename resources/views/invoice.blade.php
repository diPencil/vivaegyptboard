    ...
    <div class="modal-dialog d-flex justify-content-center align-items-center modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modelHeading">@lang('app.title')</h5>
            ...
            <div class="modal-footer">
                <button type="button" class="mr-3 rounded btn-cancel" data-dismiss="modal">@lang('app.close')</button>
                <button type="button" class="rounded btn-primary">@lang('app.save')</button>
            </div>
        </div>
    </div>
</div>
