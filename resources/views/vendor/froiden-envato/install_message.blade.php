...
<html>
<head>
    <title>VivaEgyptTravel Not installed</title>
...
<body class="bg-gray-50">
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-center mb-8">
            <img src="{{ asset('img/vivaegypttravel-logo.png') }}" class="h-12 hover:scale-105 transition-transform duration-300" alt="Home"/>
        </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-red-700 mb-1">
                        VivaEgyptTravel Installation Required
                    </h3>
