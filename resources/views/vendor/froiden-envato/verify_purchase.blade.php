...
<html>
<head>
    <title>VivaEgyptTravel - Verify Purchase</title>
    ...
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="flex flex-col items-center mb-8">
            <div class="flex items-center">
                <img src="{{ asset('img/vivaegypttravel-logo.png') }}" class="h-12 w-auto" alt="Tabletrack Logo"/>
                <h1 class="text-3xl font-bold ml-3 text-gray-800">VivaEgyptTravel</h1>
            </div>
