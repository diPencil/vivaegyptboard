...
<div class="bg-gradient-to-b from-gray-50 to-white py-14">
    ...
    <div class="container mx-auto px-2 max-w-5xl mb-10">
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
            Explore additional modules to extend your VivaEgyptTravel functionality
        </p>
    </div>
                    ...
                    <a href="{{ $module['product_link'] }}" target="_blank" class="block h-full">
                        ...
                        >
                            ...
                            <h3 class="text-sm font-bold text-amber-600 text-center mb-2 leading-tight">
                                {{ ucwords(str_replace(['for vivaegypttravel saas','for vivaegypttravel', 'vivaegypttravel', 'crm','advanced reporting projects'], '', strtolower($module['product_name']))) }}
                    ...
                    <a href="{{ $module['product_link'] }}" target="_blank" class="block h-full">
                        ...
                        >
                            ...
                            <h3 class="text-sm font-bold text-gray-900 text-center mb-2 leading-tight">
                                {{ ucwords(str_replace(['for vivaegypttravel crm', 'for vivaegypttravel','- advanced reporting  projects'], '', strtolower($module['product_name']))) }}
                            </h3>
