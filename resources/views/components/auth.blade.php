...
<header class="px-4 bg-white sticky-top d-flex justify-content-center align-items-center login_header">
    @if ($globalSetting->login_ui != 'name')
        <img class="mr-2 rounded" src="{{ $globalSetting->login_logo_url }}" alt="Logo"/>
    @endif
    @if ($globalSetting->login_ui != 'logo' && $globalSetting->sidebar_logo_style != 'full')
