...
<aside class="{{ !user()->dark_theme ? 'sidebar-' . $appTheme->sidebar_theme : '' }}">
    ...
    <div
        ...
        @if (in_array('admin', user_roles()))
            <button  type="button" class="btn px-2 py-1 btn-primary btn-sm f-10 pull-left text-truncate" style="max-width: 100%;" data-toggle="modal" data-target="#raiseSupportTicketModal">
                {{ __('app.poweredBy') }} Pencil Studio
            </button>
        @endif
        <p class="mb-0 text-dark-grey px-1 py-0 rounded f-10">v1.01</p>
    </div>
    <!-- Sidebar Toggler -->
