        ...
        <x-setting-card method="POST">
            ...
            <div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4 ">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                      fieldLabel="Login Screen Logo"
                                      :fieldValue="company()->masked_login_logo_url" fieldName="login_logo"
                                      fieldId="login_logo"
                                      :popover="__('messages.fileFormat.ImageFile')"/>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="login_ui" fieldLabel="Login Screen Display">
                            </x-forms.label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="login_ui_both"
                                                fieldLabel="Both"
                                                fieldName="login_ui" fieldValue="both" class="login_ui"
                                                :checked="(company()->login_ui == 'both' || !company()->login_ui)">
                                </x-forms.radio>

                                <x-forms.radio fieldId="login_ui_logo"
                                                fieldLabel="Logo Only"
                                                fieldValue="logo" fieldName="login_ui" class="login_ui"
                                                :checked="(company()->login_ui == 'logo')">
                                </x-forms.radio>

                                <x-forms.radio fieldId="login_ui_name"
                                                fieldLabel="Name Only"
                                                fieldValue="name" fieldName="login_ui" class="login_ui"
                                                :checked="(company()->login_ui == 'name')">
                                </x-forms.radio>
                            </div>
                        </div>
                    </div>
